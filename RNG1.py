...
# RSA Encryption
def RSAEncryption(public_key, message):
...
# Signing message
def SimpleSigning(private_key, message):
...
def RNGOne():
    ...
    randomNumber = Random512()
    signedMessage = SimpleSigning(private_key, str(randomNumber).encode('utf8'))
